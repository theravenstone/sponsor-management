...
$whereClause = ' WHERE archived = 1'; // Nur nicht archivierte Sponsoren anzeigen
$params = [];
    ...
    <div class="container">
        ...
        <div class="actions">
            ...
            <div>
                ...
                <span> | </span>
                <a href="dashboard.php">Nicht Archivierte</a>
                <span> | </span>
